...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="screencleanmac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSApplication;

SWIFT_CLASS("_TtC14screencleanmac11AppDelegate")
...
SWIFT_CLASS("_TtC14screencleanmac17MainFlutterWindow")
